...
class QueenBoardTestCase(unittest.TestCase):
  ...
  def testcanPlacedOnSpot(self):
    ...
    # And some off-diagonals.
    self.assertTrue(self.board.placed(Board.Point(1, 1)))
    self.assertTrue(self.board.placed(Board.Point(3, 1)))
    self.assertTrue(self.board.placed(Board.Point(1, 5)))
    self.assertTrue(self.board.placed(Board.Point(3, 5)))
